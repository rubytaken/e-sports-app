    ...
    >
      ...
      <div className="relative h-44 overflow-hidden bg-surface-2 shrink-0">
        {hasImage ? (
          ...
          <div className="flex h-full items-center justify-center featured-gradient">
            <span className="text-xl font-extrabold text-text-2/20 uppercase tracking-widest">
              {article.source.name}
            </span>
          </div>
        )}
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="flex items-center gap-2 mb-2">
          <span className="rounded-full bg-accent/10 border border-accent/20 px-2.5 py-0.5 text-[10px] font-bold text-accent uppercase tracking-wider truncate max-w-[50%]">
            {article.source.name}
          </span>
        ...
        {/* Title */}
        <h3 className="text-sm font-bold text-text-0 leading-snug group-hover:text-accent transition-colors line-clamp-2">
